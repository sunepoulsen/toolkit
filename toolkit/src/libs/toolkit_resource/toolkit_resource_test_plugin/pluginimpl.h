...
//-------------------------------------------------------------------------
#ifndef __TOOLKIT_RESOURCE_TEST_PLUGINIMPL_H__
#define __TOOLKIT_RESOURCE_TEST_PLUGINIMPL_H__
...
/*!
    \brief
*/
class ToolkitResourcePlugin : public QObject, TestRegisterInterface {
    Q_OBJECT
