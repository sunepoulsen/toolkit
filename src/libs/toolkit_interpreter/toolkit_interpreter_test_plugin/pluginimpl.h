...
//-------------------------------------------------------------------------
#ifndef __TOOLKIT_INTERPRETER_TEST_PLUGINIMPL_H__
#define __TOOLKIT_INTERPRETER_TEST_PLUGINIMPL_H__
...
/*!
    \brief
*/
class ToolkitInterpreterPlugin : public QObject, TestRegisterInterface {
    Q_OBJECT
